#!/usr/bin/env python3
"""
query_ogs_event_past_30days.py

Fetches Oklahoma Geological Survey (OGS) earthquake events for the past 30 days (or custom time window)
...
def query_ogs_events(days=30, start_str=None, end_str=None, min_mag=None, max_mag=None, output_file="ogs_events_past_30days.csv", quiet=False):
    """
...
def main():
    parser = argparse.ArgumentParser(
        description="Query OGS earthquake events for the past 30 days and export to complete.csv formatted CSV."
    )
    parser.add_argument(
        "--days",
        "-d",
        type=int,
        default=30,
        help="Number of past days to query (default: 30).",
    )
    parser.add_argument(
        "--start",
        type=str,
    ...
    parser.add_argument(
        ...
        "-o",
        type=str,
        default="ogs_events_past_30days.csv",
        help="Output CSV filename (default: ogs_events_past_30days.csv).",
    )
    parser.add_argument(
        "--quiet",
        "-q",
