...
def query_ogs_events(days=1, start_str=None, end_str=None, min_mag=None, max_mag=None, output_file="ogs_events_past_1days.csv", quiet=False):
    """
...
def main():
    parser = argparse.ArgumentParser(
        description="Query OGS earthquake events for the past 1 day and export to complete.csv formatted CSV."
    )
    parser.add_argument(
        "--days",
        "-d",
        type=int,
        default=1,
        help="Number of past days to query (default: 1).",
    )
    parser.add_argument(
        "--start",
        type=str,
    ...
    parser.add_argument(
        ...
        "-o",
        type=str,
        default="ogs_events_past_1days.csv",
        help="Output CSV filename (default: ogs_events_past_1days.csv).",
    )
    parser.add_argument(
        "--quiet",
        "-q",
